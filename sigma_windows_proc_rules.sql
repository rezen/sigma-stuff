...
-- sigma rule file rules/windows/process_creation/proc_creation_win_susp_builtin_commands_recon.yml;
SELECT * FROM (SELECT *,count(*) AS agg FROM eventlog WHERE (COMMAND_LINE IN ("tasklist", "net time", "systeminfo", "whoami", "nbtstat", "net start", "qprocess", "nslookup", "hostname.exe", "netstat -an") OR (COMMAND_LINE LIKE "%\\net1 start" ESCAPE '\' OR COMMAND_LINE LIKE "%\\net1 user /domain" ESCAPE '\' OR COMMAND_LINE LIKE "%\\net1 group /domain" ESCAPE '\' OR COMMAND_LINE LIKE "%\\net1 group "domain admins" /domain" ESCAPE '\' OR COMMAND_LINE LIKE "%\\net1 group "Exchange Trusted Subsystem" /domain" ESCAPE '\' OR COMMAND_LINE LIKE "%\\net1 accounts /domain" ESCAPE '\' OR COMMAND_LINE LIKE "%\\net1 user net localgroup administrators" ESCAPE '\')) GROUP BY COMMAND_LINE) WHERE agg > 4
...
-- sigma rule file rules/windows/process_creation/proc_creation_win_multiple_susp_cli.yml;
SELECT * FROM (SELECT *,count(*) AS agg FROM eventlog WHERE (COMMAND_LINE LIKE "%arp.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%at.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%attrib.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%cscript.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%dsquery.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%hostname.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%ipconfig.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%mimikatz.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%nbtstat.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%net.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%netsh.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%nslookup.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%ping.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%quser.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%qwinsta.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%reg.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%runas.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%sc.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%schtasks.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%ssh.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%systeminfo.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%taskkill.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%telnet.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%tracert.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%wscript.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%xcopy.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%pscp.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%copy.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%robocopy.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%certutil.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%vssadmin.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%powershell.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%pwsh.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%wevtutil.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%psexec.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%bcedit.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%wbadmin.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%icacls.exe%" ESCAPE '\' OR COMMAND_LINE LIKE "%diskpart.exe%" ESCAPE '\') GROUP BY MachineName) WHERE agg > 5
...
-- sigma rule file rules/custom/powershell_exploit_scripts.yml;
SELECT * FROM eventlog WHERE (COMMAND_LINE LIKE "%Invoke-DllInjection%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Shellcode%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-WmiCommand%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-GPPPassword%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-Keystrokes%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-TimedScreenshot%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-VaultCredential%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-CredentialInjection%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Mimikatz%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-NinjaCopy%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-TokenManipulation%" ESCAPE '\' OR COMMAND_LINE LIKE "%Out-Minidump%" ESCAPE '\' OR COMMAND_LINE LIKE "%VolumeShadowCopyTools%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-ReflectivePEInjection%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-UserHunter%" ESCAPE '\' OR COMMAND_LINE LIKE "%Find-GPOLocation%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-ACLScanner%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-DowngradeAccount%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-ServiceUnquoted%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-ServiceFilePermission%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-ServicePermission%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-ServiceAbuse%" ESCAPE '\' OR COMMAND_LINE LIKE "%Install-ServiceBinary%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-RegAutoLogon%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-VulnAutoRun%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-VulnSchTask%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-UnattendedInstallFile%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-ApplicationHost%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-RegAlwaysInstallElevated%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-Unconstrained%" ESCAPE '\' OR COMMAND_LINE LIKE "%Add-RegBackdoor%" ESCAPE '\' OR COMMAND_LINE LIKE "%Add-ScrnSaveBackdoor%" ESCAPE '\' OR COMMAND_LINE LIKE "%Gupt-Backdoor%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-ADSBackdoor%" ESCAPE '\' OR COMMAND_LINE LIKE "%Enabled-DuplicateToken%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-PsUaCme%" ESCAPE '\' OR COMMAND_LINE LIKE "%Remove-Update%" ESCAPE '\' OR COMMAND_LINE LIKE "%Check-VM%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-LSASecret%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-PassHashes%" ESCAPE '\' OR COMMAND_LINE LIKE "%Show-TargetScreen%" ESCAPE '\' OR COMMAND_LINE LIKE "%Port-Scan%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-PoshRatHttp%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-PowerShellTCP%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-PowerShellWMI%" ESCAPE '\' OR COMMAND_LINE LIKE "%Add-Exfiltration%" ESCAPE '\' OR COMMAND_LINE LIKE "%Add-Persistence%" ESCAPE '\' OR COMMAND_LINE LIKE "%Do-Exfiltration%" ESCAPE '\' OR COMMAND_LINE LIKE "%Start-CaptureServer%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-ChromeDump%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-ClipboardContents%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-FoxDump%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-IndexedItem%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-Screenshot%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Inveigh%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-NetRipper%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-EgressCheck%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-PostExfil%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-PSInject%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-RunAs%" ESCAPE '\' OR COMMAND_LINE LIKE "%MailRaider%" ESCAPE '\' OR COMMAND_LINE LIKE "%New-HoneyHash%" ESCAPE '\' OR COMMAND_LINE LIKE "%Set-MacAttribute%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-DCSync%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-PowerDump%" ESCAPE '\' OR COMMAND_LINE LIKE "%Exploit-Jboss%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-ThunderStruck%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-VoiceTroll%" ESCAPE '\' OR COMMAND_LINE LIKE "%Set-Wallpaper%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-InveighRelay%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-PsExec%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SSHCommand%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-SecurityPackages%" ESCAPE '\' OR COMMAND_LINE LIKE "%Install-SSP%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-BackdoorLNK%" ESCAPE '\' OR COMMAND_LINE LIKE "%PowerBreach%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-SiteListPassword%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-System%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-BypassUAC%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Tater%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-WScriptBypassUAC%" ESCAPE '\' OR COMMAND_LINE LIKE "%PowerUp%" ESCAPE '\' OR COMMAND_LINE LIKE "%PowerView%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-RickAstley%" ESCAPE '\' OR COMMAND_LINE LIKE "%Find-Fruit%" ESCAPE '\' OR COMMAND_LINE LIKE "%HTTP-Login%" ESCAPE '\' OR COMMAND_LINE LIKE "%Find-TrustedDocuments%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Paranoia%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-WinEnum%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-ARPScan%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-PortScan%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-ReverseDNSLookup%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SMBScanner%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Mimikittenz%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-AllChecks%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-BadPotato%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-BetterSafetyKatz%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Carbuncle%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Certify%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-DAFT%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-DinvokeKatz%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Eyewitness%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-FakeLogonScreen%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Farmer%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Get-RBCD-Threaded%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Gopher%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Grouper2%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-HandleKatz%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Internalmonologue%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-KrbRelayUp%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-LdapSignCheck%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Lockless%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-MITM6%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-NanoDump%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-OxidResolver%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-P0wnedshell%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-PPLDump%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Rubeus%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SCShell%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SafetyKatz%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SauronEye%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Seatbelt%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharPersist%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpAllowedToAct%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpBlock%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpBypassUAC%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpChromium%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpClipboard%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpCloud%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpDPAPI%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpDump%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpGPO-RemoteAccessPolicies%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpGPOAbuse%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpHandler%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpHide%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpHound4%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpImpersonation%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpImpersonationNoSpace%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpKatz%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpLdapRelayScan%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpLoginPrompt%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpMove%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpPrintNightmare%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpPrinter%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpRDP%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpSSDP%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpSecDump%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpSniper%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpSploit%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpSpray%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpStay%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpUp%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SharpWatson%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Sharphound2%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Sharphound3%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Sharplocker%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Sharpshares%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Sharpview%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Sharpweb%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Snaffler%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Spoolsample%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-StandIn%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-StickyNotesExtract%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Thunderfox%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Tokenvator%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-UrbanBishop%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Whisker%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-WireTap%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-winPEAS%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-Zerologon%" ESCAPE '\' OR COMMAND_LINE LIKE "%Get-USBKeystrokes%" ESCAPE '\' OR COMMAND_LINE LIKE "%Start-WebcamRecorder%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-OfficeScrape%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-DomainPasswordSpray%" ESCAPE '\' OR COMMAND_LINE LIKE "%Invoke-SpraySinglePassword%" ESCAPE '\')
